...
def train(
    ...
    for iteration in range(num_iterations):
        ...
        if iteration % save_steps == 0 or iteration == num_iterations - 1:
            ...
            # Save checkpoints
            final_image = my_haha_backprocessing(x + x_0, device)
            save_checkpoint(final_image, x+x_0, exp_path, iteration)
...
def main():
    ...
    parser.add_argument("--img_ref", type=str, default="msu.png", help="Reference image filename.")
