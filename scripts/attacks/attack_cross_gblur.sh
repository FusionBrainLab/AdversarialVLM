...
EXP_NAME="gray_crossattack_qwen_llama_llava_gblurON_ksize5_savex"
IMG_ORIG="gray.png"
...
# MODEL_NAME="microsoft/Phi-3.5-vision-instruct,alpindale/Llama-3.2-11B-Vision-Instruct,llava-hf/llava-1.5-7b-hf" 
# MODEL_NAME="Qwen/Qwen2-VL-2B-Instruct,alpindale/Llama-3.2-11B-Vision-Instruct,llava-hf/llava-1.5-7b-hf" 
MODEL_NAME="Qwen/Qwen2-VL-2B-Instruct,microsoft/Phi-3.5-vision-instruct,llava-hf/llava-1.5-7b-hf" 
...
# --target_text_random - multianswer (MA) setup
# gaussian blur
GBLUR_KERNEL_SIZE=5

# Run the Python script with all arguments
wandb online
CUDA_VISIBLE_DEVICE=0,1,2,3 python3 "src/crossattack_models.py" \
    --exp_name "$EXP_NAME" \
    --img_orig "$IMG_ORIG" \
    --prompt "$PROMPT" \
